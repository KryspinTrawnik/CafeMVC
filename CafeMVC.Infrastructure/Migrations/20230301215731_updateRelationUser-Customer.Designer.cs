...
namespace CafeMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230301215731_updateRelationUser-Customer")]
    partial class updateRelationUserCustomer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.CardType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.PaymentCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SecureityCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.Order", b =>
                {
                    ...
                    b.HasOne("CafeMVC.Domain.Model.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.Payment", b =>
                {
                    b.HasOne("CafeMVC.Domain.Model.PaymentCard", "PaymentCard")
                        .WithMany("Payments")
                        .HasForeignKey("PaymentCardId");

                    b.HasOne("CafeMVC.Domain.Model.PaymentType", "PaymentType")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("CafeMVC.Domain.Model.PaymentCard", b =>
                {
                    b.HasOne("CafeMVC.Domain.Model.CardType", "CardType")
